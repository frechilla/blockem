...
const char GUI_MENU_ITEM_SETTINGS_FORBIDDENAREA_CURRENT[]  = "radiomenuitem_settings_forbidden_current";
const char GUI_MENU_ITEM_SETTINGS_FORBIDDENAREA_OPPONENT[] = "radiomenuitem_settings_forbidden_opponent";
