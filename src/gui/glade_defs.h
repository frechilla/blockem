...
const char GUI_MENU_ITEM_VIEW[]                           = "menuitem_view";
const char GUI_MENU_ITEM_VIEW_PLAYERS_PIECES[]            = "checkmenuitem_view_opponent_pieces";
...
const char GUI_MENU_ITEM_SETTINGS_FORBIDDENAREA_PLAYER3[] = "radiomenuitem_settings_forbidden_player3";
const char GUI_MENU_ITEM_SETTINGS_FORBIDDENAREA_PLAYER4[] = "radiomenuitem_settings_forbidden_player4";
...
const char GUI_MENU_ITEM_SETTINGS_INFLUENCEAREA_PLAYER3[] = "radiomenuitem_settings_influence_player3";
const char GUI_MENU_ITEM_SETTINGS_INFLUENCEAREA_PLAYER4[] = "radiomenuitem_settings_influence_player4";
